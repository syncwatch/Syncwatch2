...
export class StorageService {
    ...
    private setupWorker(): void {
        if (typeof Worker !== 'undefined') {
            // Create a new
            this.worker = new Worker(new URL('../worker/indexeddb.worker', import.meta.url));
    ...
    async putMovieFragment(fragment: MovieFragment): Promise<void> {
        return await this.workerPostMessage('putMovieFragment', fragment);
    }
    ...
    async putThumbnail(thumbnail: Thumbnail): Promise<void> {
        return await this.workerPostMessage('putThumbnail', thumbnail);
    }

    async deleteThumbnail(thumbnail_id: string): Promise<void> {
        return await this.workerPostMessage('deleteThumbnail', thumbnail_id);
    }
}
